          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link to="/category/poem" className="hover:text-black">Poem</Link></li>
                <li><Link to="/category/story" className="hover:text-black">Story</Link></li>
                <li><Link to="/category/technology" className="hover:text-black">Technology</Link></li>
                <li><Link to="/category/travel" className="hover:text-black">Travel</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link to="/terms" className="hover:text-black">Terms of Use</Link></li>
